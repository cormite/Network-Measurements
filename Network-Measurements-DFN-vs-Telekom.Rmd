...
```{r, echo=F}
throughput <- read.csv(file='ingress-from-perfsonar.embl.es-to-perfsonar1.embl.de-and-perfsonar2.embl.de.csv', stringsAsFactors=FALSE)
```
...
```{r, echo=F}
throughput <- read.csv(file='egress-from-perfsonar1.embl.de-and-perfsonar2.embl.de-to-perfsonar.embl.es.csv', stringsAsFactors=FALSE)
```
...
```{r, echo=F}
throughput <- read.csv(file='egress-from-perfsonar1.embl.de-and-perfsonar2.embl.de-to-perfsonar.embl.it.csv', stringsAsFactors=FALSE)
```
...
```{r, echo=F}
throughput <- read.csv(file='ingress-from-perfsonar.embl.it-to-perfsonar1.embl.de-and-perfsonar2.embl.de.csv', stringsAsFactors=FALSE)
```

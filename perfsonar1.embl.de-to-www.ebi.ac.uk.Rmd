---
title: "Latency between perfsonar1.embl.de and www.ebi.ac.uk"
...
library(reshape2)
library(ggplot2)
mtr <- read.csv('perfsonar1.embl.de-to-www.ebi.ac.uk.csv', header=T, stringsAsFactors=F)
```
...
p <- p + labs(
  ...
  subtitle="Source: perfsonar1.embl.de (DFN), Destination: www.ebi.ac.uk (JANET)",
  x="IP",
  y="Latency (ms)")

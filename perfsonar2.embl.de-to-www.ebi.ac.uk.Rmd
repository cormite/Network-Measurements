---
title: "Latency between perfsonar2.embl.de and www.ebi.ac.uk"
...
library(reshape2)
library(ggplot2)
mtr <- read.csv('mtr-from-perfsonar2.embl.de-to-www.ebi.ac.uk.csv', header=T, stringsAsFactors=F)
```
...
p <- p + labs(
  ...
  subtitle="Source: perfsonar2.embl.de (Telekom), Destination: www.ebi.ac.uk (JANET)",
  x="IP",
  y="Latency (ms)")
